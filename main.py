...
def draw_smiley(renderer):
    ...
    # Draw the eyes
    draw_circle(surface, width // 2 - 20, height // 2 - 20, 5, sdl2.ext.Color(0, 0, 0))  # Left eye
    draw_circle(surface, width // 2 + 20, height // 2 - 20, 5, sdl2.ext.Color(0, 0, 0))  # Right eye
...
def main():
    ...
    window = sdl2.ext.Window("Smiley Face", size=(width, height))
    window.show()
